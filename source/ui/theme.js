...
/* Цвет остаётся семантикой рынка, но в v55 он чуть тише: интерфейс должен
   выглядеть как финансовый продукт, а не как игровое лобби. */
const LONG = "#35B779";
const SHORT = "#D65F6B";
const GOLD = "#A88D61";
const ACCENT = "#DEDAD2";
...
/* График остаётся монохромным. Цвет используется только для позиции,
   защитных уровней и результата. */
...
/* LONG/SHORT больше не заливают кнопку ярким цветом целиком. Тёмный
   тонированный фон + цветная типографика оставляют действие очевидным,
   но терминал выглядит заметно дороже и спокойнее. */
const btnAccent = (c) => ({
