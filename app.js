...
class ErrBoundary extends React.Component {
    ...
    render() {
        ...
        const text = (ACTIVE_LANG === "en" ? "MESSAGE:\n" : "СООБЩЕНИЕ:\n") + (e && e.message ? e.message : String(e)) +
...
createRoot(document.getElementById("root")).render(React.createElement(ErrBoundary, null,
    React.createElement(PracticeApp, null)));
